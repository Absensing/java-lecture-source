...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        *   [for문 표현식]
        *   for(초기식; 조건식; 증감식) {
        *       조건을 만족하는 경우 수행하 구문(반복할 구문);
        *   }
        * */


        /* 필기. 1부터 10까지 1 씩 증가시키면서(10)번 i 값을 출력하는 기본 반복문 */
    ...
    public void testForExample1() {
        ...
        /* 수업목표. 무엇을 반복하는지 확인하며 반복문으로 개선할 수 있다.(1)*/
...
//        System.out.println("첫번쨰 학생의 이름은 " + student1 + "입니다.");
//
//
//        System.out.println("2번째 학생의 이름을 입력해주세요 : ");
//        String student2 = sc.nextLine();
//        System.out.println("두번쨰 학생의 이름은 " + student2 + "입니다.");
//
//
//        System.out.println("3번째 학생의 이름을 입력해주세요 : ");
//        String student3 = sc.nextLine();
//        System.out.println("세번쨰 학생의 이름은 " + student3 + "입니다.");
//
//
//        System.out.println("4번째 학생의 이름을 입력해주세요 : ");
//        String student4 = sc.nextLine();
//        System.out.println("네번쨰 학생의 이름은 " + student4 + "입니다.");
//
//
//        System.out.println("5번째 학생의 이름을 입력해주세요 : ");
//        String student5 = sc.nextLine();
//        System.out.println("5번쨰 학생의 이름은 " + student5 + "입니다.");
//
//
//        System.out.println("5명의 학생 이름을 입력받고 출력하는 기능 완료!!!");
    ...
    public void testForExample3() {
        ...
        /* 수업목표. 무엇을 반복하는지 확인항 반복문으로 개선할 수 있다. (3)*/

        /* 필기.
        *   5 ~ 10 사이의 난수를 발생시켜
        *   1에서 발생한 난수까지의 합계를 구해보자.
        * */
        ...
        * */
        ...
        Scanner sc = new Scanner(System.in);
            ...
            *   작은수 ~ 큰수까지의 합계를 구하는 로직으로 바꿀 수 있다.
            * */

            /*필기. 더 큰 값과 작은 값을 저장한 변수를 초기화한다. */
            int min = 0;
            int max = 0;
