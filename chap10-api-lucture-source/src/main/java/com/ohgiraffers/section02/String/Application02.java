...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("str1의 hsathocode : " + str1.hashCode());
        System.out.println("str2의 hsathocode : " + str2.hashCode());
        System.out.println("str3의 hsathocode : " + str3.hashCode());
        System.out.println("str4의 hsathocode : " + str4.hashCode());

        /* 필기.
        *   equals() : String 클래스의 equals() 메소드는 인스턴스 비교가 아닌 문자열 값을 비교
