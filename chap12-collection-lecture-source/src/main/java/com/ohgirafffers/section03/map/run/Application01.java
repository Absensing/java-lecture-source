package com.ohgirafffers.section03.map.run;
...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   2. 키는 중복을 허용하지 않지마느 키가 다르면 중복되는 값을 저장 가능하다.
        *
        * 필기.
        *  HashMap, HashTable, TreeMap이 대표적인 클래스이다.
        *   HashMap이 가장 많이 쓰인다.
        * */
...
//        List list = new ArrayList<>();
        ...
        System.out.println("z키 12번에 대한 객체 : " + hmap.get(12));

        HashMap<String, String> hmap2 = new HashMap<>();

        hmap2.put("one", "java");
        hmap2.put("two", "mysql");
        hmap2.put("three", "jabc");
        hmap2.put("four", "html");
        hmap2.put("five", "css");
